      ...
      >
        <div class="p-6">
          <div class="flex justify-between items-start mb-3">
            <h2 class="text-xl font-semibold mb-2 text-blue-700">{{ project.name }}</h2>
            <a :href="project.repoUrl" target="_blank" class="text-gray-500 hover:text-gray-700">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.605-3.369-1.343-3.369-1.343-.454-1.157-1.11-1.465-1.11-1.465-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.699 1.028 1.592 1.028 2.683 0 3.841-2.337 4.687-4.565 4.935.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12c0-5.523-4.477-10-10-10z" clip-rule="evenodd"></path>
              </svg>
            </a>
          </div>
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div class="flex-grow">
            <div class="flex items-start justify-between">
              ...
              <a :href="project.repoUrl" target="_blank" class="text-gray-500 hover:text-gray-700 ml-2">
...
const projects = ref([
  {
    id: 1,
    name: 'Vue Dashboard',
    description: 'A responsive admin dashboard built with Vue.js and Tailwind CSS with dark mode support and customizable widgets.',
  ...
  },
  {
    id: 2,
    name: 'E-Commerce API',
    description: 'RESTful API for e-commerce applications with user authentication, product management, and order processing.',
  ...
  },
  {
    ...
    description: 'Personal portfolio website showcasing projects and skills with a modern, minimalist design.',
  ...
  },
  {
    id: 4,
    name: 'Weather App',
    description: 'A weather forecast application providing real-time weather data with location detection and 5-day forecasts.',
  ...
  },
  {
    id: 5,
    name: 'Task Manager',
    description: 'Collaborative task management application with real-time updates, task assignments, and progress tracking.',
...
// Filtered projects based on search and tech filter
const filteredProjects = computed(() => {
  return projects.value.filter(project => {
    ...
    const matchesTech = techFilter.value === '' || 
      project.technologies.includes(techFilter.value);

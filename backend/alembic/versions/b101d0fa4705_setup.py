...
Revision ID: b101d0fa4705
Revises:
Create Date: 2025-04-30 16:57:18.044499
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_technology_user_id"), "technology", ["user_id"], unique=False
    )
    op.create_table(
        "journal_entry",
        sa.Column("id", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_index(
        op.f("ix_journal_entry_user_id"), "journal_entry", ["user_id"], unique=False
    )
    op.create_table(
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_technology_user_id"), table_name="technology")
